...
## Tier System
| Feature | Trial (10 days) | Free | Pro $29/mo | Elite $69/mo |
|---------|-----------------|------|------------|--------------|
...
- New signups get 10-day Elite trial (no CC required), then downgrade to Free
...
## Previous Session Changes (2026-03-26)
...
- **ElevenLabs credits exhausted** — needs partner to upgrade plan
- Vercel env vars for ElevenLabs updated ✅ (API key + voice ID)
- Supabase redirect URL for password reset still needs to be added in dashboard
